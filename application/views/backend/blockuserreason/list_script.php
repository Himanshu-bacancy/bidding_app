...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_blockuserreason_label' ),
		'message' => get_msg( 'blockuserreason_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'blockuserreason_yes_all_label' ),
		'no_only_btn' => get_msg( 'blockuserreason_no_only_label' )
	);
