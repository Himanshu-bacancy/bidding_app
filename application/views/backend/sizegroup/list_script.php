...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_sizegroup_label' ),
		'message' => get_msg( 'sizegroup_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'sizegroup_yes_all_label' ),
		'no_only_btn' => get_msg( 'sizegroup_no_only_label' )
	);
