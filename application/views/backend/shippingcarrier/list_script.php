...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_shippingcarrier_label' ),
		'message' => get_msg( 'shippingcarrier_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'shippingcarrier_yes_all_label' ),
		'no_only_btn' => get_msg( 'shippingcarrier_no_only_label' )
	);
