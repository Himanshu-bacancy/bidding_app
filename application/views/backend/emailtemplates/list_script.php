...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_template_label' ),
		'message' => get_msg( 'template_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'template_yes_all_label' ),
		'no_only_btn' => get_msg( 'template_no_only_label' )
	);
