...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_deliverymethod_label' ),
		'message' => get_msg( 'deliverymethod_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'deliverymethod_yes_all_label' ),
		'no_only_btn' => get_msg( 'deliverymethod_no_only_label' )
	);
