...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_reportitemreason_label' ),
		'message' => get_msg( 'reportitemreason_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'reportitemreason_yes_all_label' ),
		'no_only_btn' => get_msg( 'reportitemreason_no_only_label' )
	);
