...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_promotingitemplan_label' ),
		'message' => get_msg( 'promotingitemplan_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'promotingitemplan_yes_all_label' ),
		'no_only_btn' => get_msg( 'promotingitemplan_no_only_label' )
	);
