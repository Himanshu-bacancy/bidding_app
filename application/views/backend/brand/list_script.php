...
<?php
	...
	$data = array(
		'title' => get_msg( 'delete_brand_label' ),
		'message' => get_msg( 'brand_delete_confirm_message' ) .'<br>',
		'yes_all_btn' => get_msg( 'brand_yes_all_label' ),
		'no_only_btn' => get_msg( 'brand_no_only_label' )
	);
