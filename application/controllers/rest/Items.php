...
//		}
        ...
        if(!empty($this->post('expiration_date_days'))) {
	  	...
	  	$item_data = array(
        	...
        	"cat_id" => $this->post('cat_id') ? $this->post('cat_id') : '', 
        	"sub_cat_id" => $this->post('sub_cat_id') ? $this->post('sub_cat_id') : '',
        	"item_type_id" => $this->post('item_type_id') ? $this->post('item_type_id') : '',
        	"condition_of_item_id" => $this->post('condition_of_item_id') ? $this->post('condition_of_item_id') : '',
        	"description" => $this->post('description') ? $this->post('description') : '',
        	"price" => $this->post('price') ? $this->post('price') : '',
        	"brand" => $this->post('brand') ? $this->post('brand') : '',
        	"title" => $this->post('title') ? $this->post('title') : '',
        	"status" => $status,
        	"id" => $this->post('id'),
			"delivery_method_id" => $this->post('delivery_method_id') ? $this->post('delivery_method_id') : '',
			"address_id" => $this->post('address_id') ? $this->post('address_id') : '',
			"childsubcat_id" => $this->post('childsubcat_id') ? $this->post('childsubcat_id') : '',
			"sizegroup_id" => $this->post('sizegroup_id') ? $this->post('sizegroup_id') : '',
			"childsubcat_id" => $this->post('childsubcat_id') ? $this->post('childsubcat_id') : '',
			"is_all_colors" => $this->post('is_all_colors') ? $this->post('is_all_colors') : '',
			"pieces" => $this->post('pieces') ? $this->post('pieces') : '',
			"is_negotiable" => $this->post('is_negotiable') ? $this->post('is_negotiable') : '',
			"negotiable_percentage" => $this->post('negotiable_percentage') ? $this->post('negotiable_percentage') : '',
			"expiration_date_days" => $this->post('expiration_date_days') ? $this->post('expiration_date_days') : '',
			"expiration_date" => $expiration_date ? $expiration_date : '',
			"pickup_distance" => $this->post('pickup_distance') ? $this->post('pickup_distance') : '',
			"observation" => $this->post('observation') ? $this->post('observation') : '',
			"is_draft" => $this->post('is_draft') ? $this->post('is_draft') : '',
			...
			"is_accept_similar" => $this->post('is_accept_similar') ? $this->post('is_accept_similar') : '',
			"is_confirm" => $this->post('is_confirm') ? $this->post('is_confirm') : '',
        	"added_user_id" => $this->post('added_user_id') ? $this->post('added_user_id') : '',
        	"added_date" =>  date("Y-m-d H:i:s")
